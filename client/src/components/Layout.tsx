        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="leading-tight hidden sm:block">
              <div className="text-court-white font-display font-black text-xl" style={{ letterSpacing: "0.12em" }}>
                10IS
              </div>
              <div className="text-net-grey text-[10px] font-normal" style={{ letterSpacing: "0.05em" }}>
      ...
      <footer className="bg-chalk text-court-black py-12 mt-12">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-3 mb-3">
            <img src="/logo-editorial.png" alt="" className="h-9 w-9 object-contain" />
            <span className="font-display font-black text-lg text-court-black" style={{ letterSpacing: "0.12em" }}>
              10IS
            </span>
          </div>
